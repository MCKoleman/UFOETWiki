			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 lg:gap-8">
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						...
						<DollarSign className="size-4 text-foreground-muted" />
					</CardHeader>
					<CardContent>
							...
							<TableBody>
								<TableRow>
									<TableCell>
										...
										<div className="hidden text-sm text-foreground-muted md:inline">
											liam@example.com
										</div>
									</TableCell>
				...
				<Card>
					...
					<CardContent className="grid gap-8">
						...
						<div className="flex items-center gap-4">
							<Avatar className="hidden h-9 w-9 sm:flex">
								<AvatarImage
									src="https://i.pravatar.cc/180?img=2"
									alt="Avatar"
								/>
						...
						<div className="flex items-center gap-4">
							<Avatar className="hidden h-9 w-9 sm:flex">
								<AvatarImage
									src="https://i.pravatar.cc/180?img=4"
									alt="Avatar"
								/>
							...
							<div className="grid gap-1">
								...
								<p className="text-sm text-foreground-muted">will@email.com</p>
							</div>
